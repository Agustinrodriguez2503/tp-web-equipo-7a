            ...
            <div class="col-md-4">
                <div class="custom-carousel mx-auto">
                    ...
                    <div class="text-center mt-3">
                        ...
                        <asp:Button ID="btnSeleccionarUno" runat="server" CssClass="btn btn-primary btn-select" Onclick="btnSeleccionarUno_Click" Text="¡Seleccionar!"/>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="custom-carousel mx-auto">
                    ...
                    <div class="text-center mt-3">
                        ...
                        <asp:Button ID="btnSeleccionarDos" runat="server" CssClass="btn btn-primary btn-select" OnClick="btnSeleccionarUno_Click" Text="¡Seleccionar!" />
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="custom-carousel mx-auto">
                    ...
                    <div class="text-center mt-3" style="margin-bottom: 20px">
                        ...
                        <asp:Button ID="btnSeleccionarTres" runat="server" CssClass="btn btn-primary btn-select" onclick="btnSeleccionarUno_Click" Text="¡Seleccionar!" />
                    </div>
                </div>
            </div>
        </div>
